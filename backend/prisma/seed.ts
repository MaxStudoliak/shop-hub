...
async function main() {
  ...
  const categories = await Promise.all([
    ...
    prisma.category.upsert({
      ...
      create: {
        ...
        image: 'https://images.unsplash.com/photo-1461896836934- voices-from-the-outside?w=400'
      }
    }),
    prisma.category.upsert({
      where: { slug: 'books' },
  ...
  const products = [
    ...
    },
    {
      ...
      stock: 80,
      categorySlug: 'electronics',
      images: ['https://images.unsplash.com/photo-1625723044792-44de16ccb4e8?w=800']
    },
    ...
    // Automotive
    {
      ...
      images: ['https://images.unsplash.com/photo-1609692814859-f1d1fc738d0f?w=800']
    },
    {
